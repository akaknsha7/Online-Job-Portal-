...
<html lang="en">
    ...
    <body>
        ...
        <%
            ...
            PreparedStatement pst = con.prepareStatement("select *from jobs where cname='" + key + "'");
            ResultSet rs = pst.executeQuery();
            Statement stmt = con.createStatement();
            boolean status = stmt.execute("select *from jobs where cname='" + key + "'");
        %>
        <div class="container-fluid d-flex justify-content-around flex-wrap">
            ...
            <div class="card card-custom bg-white border-white border-0 outline-outward">
                ...
                <div
                    ...
                    style="background: inherit; border-color: inherit; display: flex;justify-content: flex-end"
                    >
                    <a href="applyform.jsp?recruiter=<%=rs.getString(7)%>&cname=<%=rs.getString(3)%>&jrole=<%=rs.getString(4)%>" class="button raise">Apply</a>
                </div>
            </div>
            <%xx++;}if(xx==0){%>
            <h4 class="mt-5 text-danger">No Result Found...</h4>
            <%}%>
        </div>
        <br /><br /><br />
        <footer class="footer">
